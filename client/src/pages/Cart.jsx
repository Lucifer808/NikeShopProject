...
import { getCartItems, getTotalPrice } from '../redux/reduxCart';
import { removeProduct } from '../redux/reduxCart';
                    ...
                    <Info>
                        ...
                        <Product>
                            ...
                            <PriceDetail>
                                ...
                                <ProductPrice>{product.totalPrice?.toLocaleString()} VND</ProductPrice>
                            </PriceDetail>
                                <HighlightOffIcon style={{margin: '5px 5px', cursor: 'pointer'}} onClick={() => dispatch(removeProduct({cartItemId: product.productId}))}></HighlightOffIcon>
                        </Product>))}
                        <Hr></Hr>
                    </Info>
                    <Summary>
